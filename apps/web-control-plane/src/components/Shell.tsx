...
import { LayoutDashboard, Play, ShieldAlert, ListFilter, Settings, LogOut, ChevronRight, Activity, Calendar, User, Search, TrendingUp, Shield, FileText, Zap } from 'lucide-react';
