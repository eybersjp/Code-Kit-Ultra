...
export type SkillKind = "generated" | "installed";
export type SkillReviewStatus = "generated" | "reviewed" | "approved" | "promoted";
...
export interface PersistentMemory {
  ...
  successfulAdapterSelections: Record<string, string[]>;
  adapterSuccessCounts: Record<string, number>;
  promotedSkills: Record<string, string>;
  lastIdeas: string[];
}
