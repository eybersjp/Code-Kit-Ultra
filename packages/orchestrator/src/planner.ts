...
export function buildInitialPlan(input: UserInput): PlanTask[] {
  return [
    ...
    { id: "p5", phase: "implementation", taskType: "implementation", title: "Analyze implementation path", description: "Prepare an implementation-ready structured response.", doneDefinition: "Implementation path is defined." },
