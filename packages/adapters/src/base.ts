...
export abstract class BaseAdapter implements PlatformAdapter {
  constructor(public readonly name: string, public readonly kind: "real" | "stub", public readonly supportedTaskTypes: TaskType[]) {}
  canHandle(taskType: TaskType): boolean { return this.supportedTaskTypes.includes(taskType); }
  ...
  async dryRunExecute(payload: unknown) { return { ok: true, output: { adapter: this.name, dryRun: true, payload }, classification: "simulated" as const }; }
