...
const MODE_POLICIES: Record<Mode, ModePolicy> = {
  ...
  safe: {
    mode: "safe",
    label: "Safe",
    description: "Maximum safety with mandatory human-in-the-loop for all changes.",
  ...
  balanced: {
    mode: "balanced",
    label: "Balanced",
    description: "A balanced approach between automation and control.",
    maxClarifyingQuestions: 10,
    gateThresholds: {
      maxQuestionsBeforeReview: 4,
      maxQuestionsBeforeBlock: 8,
      minimumPlanTasks: 6,
      minimumSelectedSkills: 2,
  ...
  god: {
    mode: "god",
    label: "God",
    description: "Full autonomic operation with zero human intervention required.",
